...
content.text = content.text.replace(
  '<h1 style="text-align:center;font-weight:900;font-size:22px">',
  '<h1 style="text-align:center;font-weight:900;font-size:22px;font-family:Impact,\'Arial Narrow\',sans-serif">'
)
