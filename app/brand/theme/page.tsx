          ...
          <div className="lg:sticky lg:top-8 lg:self-start flex flex-col gap-6">
            ...
            <Card>
              ...
              <CardContent className="p-4">
                <div className="rounded-lg overflow-hidden shadow-xl mx-auto border-2" style={{ backgroundColor: backgroundPrimary, color: bodyColor, fontFamily: bodyFont, fontSize: `${baseFontSize}px`, maxWidth: "320px", borderColor: primary }}>
