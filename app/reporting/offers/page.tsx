...
// Keyed by "offerName|price" — plain-English observations with economic reframing
const OFFER_INSIGHTS: Record<string, OfferInsight[]> = {
  "GlowSerum Pro × 1|47": [
    { adName: "", insight: "Pricing GlowSerum Pro × 1 at $47 instead of $45 decreased take rate by 0.4%", date: "2026-04-14T15:00:00", observationHeadline: "(3", observationBullets: ["(3.1% vs. 3.5%). The $2 increase crossed a price-sensitivity threshold where meaningfully fewer single-unit buyers converted — at current traffic, the margin gained on the higher price doesn't offset the volume lost."] },
  ],
  "GlowSerum Pro × 2|94": [
    { adName: "", insight: "Pricing GlowSerum Pro × 2 at $94 instead of $90 decreased take rate by 0.3%", date: "2026-04-14T12:00:00", observationHeadline: "(4", observationBullets: ["(4.1% vs. 4.4%). The $4 increase looks small on paper but crosses a price threshold — the $90 version produced $37k more in revenue at the same view volume."] },
    { adName: "", insight: "Customers who chose GlowSerum Pro × 2 at $94 spent an average of $105", date: "2026-04-14T10:00:00", observationHeadline: "— $11 of additional items at checkout", observationBullets: ["— $11 of additional items at checkout. The attach beyond the bundle itself is where the real margin sits; the bundle price anchors the order, but the downstream add-ons compound it."] },
  ],
  "GlowSerum Pro × 3|141": [
    { adName: "", insight: "Customers who chose GlowSerum Pro × 3 at $141 spent an average of $159", date: "2026-04-14T09:00:00", observationHeadline: "— $18 of additional items at checkout", observationBullets: ["— $18 of additional items at checkout. The top-tier bundle doesn't just produce higher primary revenue; it produces a buyer who adds more at checkout. The $18 attach alone is meaningful revenue that wouldn't exist if buyers traded down to smaller bundles."] },
    { adName: "", insight: "Pricing GlowSerum Pro × 3 at $141 instead of $135 decreased take rate by 0.1%", date: "2026-04-14T07:00:00", observationHeadline: "(2", observationBullets: ["(2.6% vs. 2.7%). At this bundle size, the price change barely moved conversion — top-tier buyers are already self-selecting for the largest option regardless of small price variations."] },
  ],
  "GlowSerum Pro × 1|45": [
    { adName: "", insight: "Pricing GlowSerum Pro × 1 at $45 instead of $47 increased take rate by 0.4%", date: "2026-04-14T06:00:00", observationHeadline: "(3", observationBullets: ["(3.5% vs. 3.1%) and generated 57% more orders. The $2 difference isn't a margin decision — it's a volume threshold. Below $46, the single unit pulls substantially more buyers; above it, volume drops disproportionately."] },
    { adName: "", insight: "Pairing GlowSerum Pro × 1 at $45 with GlowSerum Pro × 2 at $90 as the middle option increased the middle option's take rate to 5.1%", date: "2026-04-14T04:00:00", observationHeadline: "— the highest of any GlowSerum configuration", observationBullets: ["— the highest of any GlowSerum configuration. The job of this single unit isn't to sell well on its own; it's to make the 2-pack feel like the smart choice. A 2x price step between them does that cleanly."] },
  ],
  "GlowSerum Pro × 2|90": [
    { adName: "", insight: "Pricing GlowSerum Pro × 2 at $90 instead of $94 increased take rate by 0.3%", date: "2026-04-14T03:00:00", observationHeadline: "(4", observationBullets: ["(4.4% vs. 4.1%) and generated 72% more orders. The $4 decrease unlocked a volume tier that $94 didn't reach — this isn't a gentle price curve, it's a threshold effect near $92."] },
    { adName: "", insight: "Pairing GlowSerum Pro × 2 at $90 with GlowSerum Pro × 1 at $45 as the cheaper option increased take rate to 5.1%", date: "2026-04-14T01:00:00", observationHeadline: "— the best-performing configuration for this offer", observationBullets: ["— the best-performing configuration for this offer. The $45 single isn't anchoring on absolute value; it's anchoring on the 2x ratio to the bundle, making the bundle feel like the clearly better deal."] },
    { adName: "", insight: "Customers who chose GlowSerum Pro × 2 at $90 spent an average of $100", date: "2026-04-13T23:00:00", observationHeadline: "— $10 of additional items at checkout", observationBullets: ["— $10 of additional items at checkout. The attach behavior stayed consistent across every configuration this offer appeared in, suggesting the attach is a property of this bundle size's buyer, not the page context."] },
  ],
  "GlowSerum Pro × 3|135": [
    { adName: "", insight: "Pricing GlowSerum Pro × 3 at $135 instead of $141 increased take rate by 0.1%", date: "2026-04-14T00:00:00", observationHeadline: "(2", observationBullets: ["(2.7% vs. 2.6%). The flat response at the top tier suggests further price reduction wouldn't grow volume meaningfully — top-bundle buyers aren't price-shopping within small ranges."] },
    { adName: "", insight: "Customers who chose GlowSerum Pro × 3 at $135 spent an average of $149", date: "2026-04-13T22:00:00", observationHeadline: "— $14 of additional items at checkout", observationBullets: ["— $14 of additional items at checkout. Buyers at the lower top-tier price show slightly smaller attach than those at $141, consistent with more price-conscious top-tier buyers keeping overall spend down."] },
  ],
  "GlowSerum Pro × 3 + Daily Moisturizer × 1|166": [
    { adName: "", insight: "Selling a GlowSerum Pro × 3 + Daily Moisturizer × 1 bundle at $166 instead of a plain GlowSerum Pro × 3 at $141 decreased take rate by 0.2%", date: "2026-04-13T21:00:00", observationHeadline: "(2", observationBullets: ["(2.4% vs. 2.6%) but increased revenue by $5,566. The bundle is pulling a slightly narrower slice of buyers, but each buyer spent meaningfully more per order — the tradeoff pays off at this view volume."] },
    { adName: "", insight: "Customers who chose GlowSerum Pro × 3 + Daily Moisturizer × 1 at $166 spent an average of $184", date: "2026-04-13T19:00:00", observationHeadline: "— $18 of additional items at checkout", observationBullets: ["— $18 of additional items at checkout. The moisturizer doesn't displace other attach; it stacks on top of it, consistent with skincare buyers who frame spending as completing a regimen rather than budgeting against a ceiling."] },
  ],
  "GlowSerum Pro × 1 + Daily Moisturizer × 1|75": [
    { adName: "", insight: "Selling a GlowSerum Pro × 1 + Daily Moisturizer × 1 bundle at $75 produced a 4.0% take rate", date: "2026-04-13T18:00:00", observationHeadline: "— nearly matching the 4", observationBullets: ["— nearly matching the 4.1% take rate of a plain GlowSerum Pro × 2 at $94 at a comparable price. Buyers respond about equally to \"two of the same\" and \"two complementary products\" at this price range, suggesting the bundle category is flexible at this tier."] },
    { adName: "", insight: "Customers who chose GlowSerum Pro × 1 + Daily Moisturizer × 1 at $75 spent an average of $83", date: "2026-04-13T16:00:00", observationHeadline: "— $8 of additional items at checkout", observationBullets: ["— $8 of additional items at checkout. The small attach indicates buyers treated the bundle as the complete purchase rather than a starting point."] },
  ],
  "GlowSerum Pro × 3 + Daily Moisturizer × 1|159": [
    { adName: "", insight: "Pricing the GlowSerum Pro × 3 + Daily Moisturizer × 1 bundle at $159 instead of $166 increased take rate by 0.2%", date: "2026-04-13T15:00:00", observationHeadline: "(2", observationBullets: ["(2.6% vs. 2.4%) and generated $5,444 more in revenue. The $7 decrease crosses a sub-$160 threshold — the price point does as much work as the bundle composition."] },
    { adName: "", insight: "Customers who chose GlowSerum Pro × 3 + Daily Moisturizer × 1 at $159 spent an average of $181", date: "2026-04-13T13:00:00", observationHeadline: "— $22 of additional items at checkout, the largest attach of any GlowSerum sales page configuration", observationBullets: ["— $22 of additional items at checkout, the largest attach of any GlowSerum sales page configuration. Committing to a multi-product bundle appears to open buyers to additional items rather than cap their spend."] },
  ],
  "GlowSerum Pro × 2|91": [
    { adName: "", insight: "Positioning GlowSerum Pro × 2 at $91 as a post-purchase upsell increased take rate to 21.4%", date: "2026-04-13T12:00:00", observationHeadline: "— roughly 5x the same offer's sales page take rate", observationBullets: ["— roughly 5x the same offer's sales page take rate. The upsell position doesn't just catch buyers at a different moment; it catches a fundamentally different buyer — one who has already committed and shows much less price resistance to a related second offer."] },
    { adName: "", insight: "Pricing GlowSerum Pro × 2 at $91 instead of $94 on the upsell page increased take rate by 3%", date: "2026-04-13T10:00:00", observationHeadline: "(21", observationBullets: ["(21.4% vs. 18.4%). Even at the upsell position, a $3 difference moves acceptance meaningfully — price thresholds still matter after conversion, just with different ceilings."] },
  ],
  "GlowSerum Pro × 2|94_upsell": [
    { adName: "", insight: "Pricing GlowSerum Pro × 2 at $94 instead of $91 on the upsell page decreased take rate by 3%", date: "2026-04-13T09:00:00", observationHeadline: "(18", observationBullets: ["(18.4% vs. 21.4%). The threshold that matters at this bundle size isn't $94 vs. $90 — it's the $91 ceiling for post-purchase acceptance."] },
  ],
  "Down Alternative Pillow × 1|125": [
    { adName: "", insight: "Pricing Down Alternative Pillow × 1 at $125 instead of $120 decreased take rate by 0.3%", date: "2026-04-13T06:00:00", observationHeadline: "(2", observationBullets: ["(2.8% vs. 3.1%) and generated 59% fewer orders. The $5 difference isn't a gentle slope — it's a psychological break in how buyers evaluate a single-pillow purchase."] },
    { adName: "", insight: "Customers who chose the single pillow at $125 spent an average of $141", date: "2026-04-13T04:00:00", observationHeadline: "— $16 of additional items at checkout", observationBullets: ["— $16 of additional items at checkout. Single-pillow buyers add small items but don't trade up to bundles, consistent with shoppers who arrived looking for exactly one pillow rather than evaluating their options."] },
  ],
  "Down Alternative Pillow × 2|250": [
    { adName: "", insight: "Pricing Down Alternative Pillow × 2 at $250 instead of $239 decreased take rate by 0.4%", date: "2026-04-13T03:00:00", observationHeadline: "(4", observationBullets: ["(4.5% vs. 4.9%) and cut revenue by more than half. The $11 difference crosses a threshold near $240 that fundamentally changes buyer willingness — this isn't a pricing decision with a margin tradeoff, it's a cliff."] },
    { adName: "", insight: "Customers who chose Down Alternative Pillow × 2 at $250 spent an average of $275", date: "2026-04-13T01:00:00", observationHeadline: "— $25 of additional items at checkout", observationBullets: ["— $25 of additional items at checkout. The 2-pack buyer profile shows consistent mid-sized attach regardless of configuration, suggesting this bundle size produces a predictable attach pattern independent of page context."] },
  ],
  "Down Alternative Pillow × 3|374": [
    { adName: "", insight: "Customers who chose Down Alternative Pillow × 3 at $374 spent an average of $423", date: "2026-04-13T00:00:00", observationHeadline: "— $49 of additional items at checkout, the largest per-order attach of any pillow configuration", observationBullets: ["— $49 of additional items at checkout, the largest per-order attach of any pillow configuration. The 3-pack doesn't just produce more primary revenue; it produces a buyer with substantially different basket behavior — upmarket buyers treat checkout add-ons as a natural extension of an already committed order."] },
  ],
  "Down Alternative Pillow × 1|120": [
    { adName: "", insight: "Pricing Down Alternative Pillow × 1 at $120 instead of $125 increased take rate by 0.3%", date: "2026-04-12T21:00:00", observationHeadline: "(3", observationBullets: ["(3.1% vs. 2.8%) and generated 142% more orders. The $5 difference more than doubles the single-pillow buyer pool — sub-$125 is where the mental category \"reasonable single-pillow purchase\" sits."] },
    { adName: "", insight: "Customers who chose Down Alternative Pillow × 1 at $120 spent an average of $131", date: "2026-04-12T19:00:00", observationHeadline: "— $11 of additional items at checkout", observationBullets: ["— $11 of additional items at checkout. Buyers at this lower price add less than buyers at $125 do, consistent with the lower price attracting a more budget-conscious segment who keeps their basket tight."] },
  ],
  "Down Alternative Pillow × 2|239": [
    { adName: "", insight: "Pricing Down Alternative Pillow × 2 at $239 instead of $250 increased take rate by 0.4%", date: "2026-04-12T18:00:00", observationHeadline: "(4", observationBullets: ["(4.9% vs. 4.5%) and more than doubled revenue. The $11 decrease doesn't just trim margin — it unlocks a substantially larger buyer pool, meaning the higher price isn't protecting margin, it's capping volume."] },
    { adName: "", insight: "Selling a Pillow × 3 + Sleep Mask bundle at $385 as the top option instead of a plain Pillow × 3 at $374 increased Down Alternative Pillow × 2's share of orders by 6%", date: "2026-04-12T16:00:00", observationHeadline: "(54% vs", observationBullets: ["(54% vs. 48%). The top-tier offer's job isn't to sell — it's to make the middle option feel like the smart choice. A bundle with visible add-ons does that better than a plain scale-up does."] },
  ],
  "Down Alternative Pillow × 3|359": [
    { adName: "", insight: "Pricing Down Alternative Pillow × 3 at $359 instead of $374 increased take rate by 0.3%", date: "2026-04-12T15:00:00", observationHeadline: "(2", observationBullets: ["(2.3% vs. 2.0%). The $15 decrease pulls in a small additional share of top-bundle buyers — at the top tier, price movements produce smaller volume shifts than they do at entry or middle tiers."] },
    { adName: "", insight: "Customers who chose Down Alternative Pillow × 3 at $359 spent an average of $402", date: "2026-04-12T13:00:00", observationHeadline: "— $43 of additional items at checkout", observationBullets: ["— $43 of additional items at checkout. Even at a reduced price, the top-bundle buyer profile maintains its strong attach behavior — attach appears to be a property of the tier choice, not the absolute price."] },
  ],
  "Down Alternative Pillow × 3 + Sleep Mask × 1|385": [
    { adName: "", insight: "Selling a Pillow × 3 + Sleep Mask bundle at $385 instead of a plain Pillow × 3 at $374 decreased take rate by 0.2%", date: "2026-04-12T12:00:00", observationHeadline: "(1", observationBullets: ["(1.8% vs. 2.0%) but increased AOV by $9. The bundle narrows the buyer pool slightly but the ones it captures spend more per order — worth it at this view volume."] },
    { adName: "", insight: "Customers who chose Down Alternative Pillow × 3 + Sleep Mask × 1 at $385 spent an average of $431", date: "2026-04-12T10:00:00", observationHeadline: "— $46 of additional items at checkout", observationBullets: ["— $46 of additional items at checkout. Starting from a higher baseline doesn't appear to suppress attach; the bundle's composition and base order value compound rather than trade off."] },
  ],
  "Down Alternative Pillow × 3 + Sleep Mask × 1|369": [
    { adName: "", insight: "Pricing the Pillow × 3 + Sleep Mask bundle at $369 instead of $385 increased take rate by 0.3%", date: "2026-04-12T09:00:00", observationHeadline: "(2", observationBullets: ["(2.1% vs. 1.8%). The $16 drop unlocks additional top-tier acceptance without changing what's in the bundle — price is doing the lifting, not composition."] },
  ],
  "Down Alternative Pillow × 2|247": [
    { adName: "", insight: "Positioning Down Alternative Pillow × 2 at $247 as a post-purchase upsell produced a 12.8% take rate", date: "2026-04-12T06:00:00", observationHeadline: "— roughly 3x the same bundle's sales page rate", observationBullets: ["— roughly 3x the same bundle's sales page rate. Single-pillow buyers aren't finished shopping at the sales page; the upsell position captures meaningful trade-up intent that the sales page alone doesn't surface."] },
    { adName: "", insight: "Customers who accepted Down Alternative Pillow × 2 at $247 as an upsell spent an average of $368 in total", date: "2026-04-12T04:00:00", observationHeadline: ", combining their initial pillow purchase with the upsell offer", observationBullets: [", combining their initial pillow purchase with the upsell offer. These buyers effectively doubled their basket from their initial single-pillow intent — the upsell didn't convert a different buyer, it expanded the same buyer's order."] },
  ],
  "Daily Moisturizer × 1|26": [
    { adName: "", insight: "Positioning Daily Moisturizer × 1 at $26 as a post-purchase upsell produced a 26.6% take rate", date: "2026-04-12T03:00:00", observationHeadline: "— the highest upsell rate in the account", observationBullets: ["— the highest upsell rate in the account. A $26 price on a routine-completion pairing operates closer to a default \"yes\" than a considered decision, which is where small-ticket upsells earn their keep."] },
    { adName: "", insight: "Showing Daily Moisturizer × 1 at $26 after a GlowSerum bundle purchase instead of a single-unit GlowSerum purchase increased take rate by 2x.", date: "2026-04-12T01:00:00", observationHeadline: "The bundle buyer isn't just a larger-cart version of the single-unit buyer — they're a categorically more receptive audience for further skincare, suggesting attach behavior follows commitment level, not just cart size", observationBullets: ["The bundle buyer isn't just a larger-cart version of the single-unit buyer — they're a categorically more receptive audience for further skincare, suggesting attach behavior follows commitment level, not just cart size."] },
    { adName: "", insight: "Showing Daily Moisturizer × 1 at $26 on orders over $200 instead of orders under $150 increased take rate by 12%", date: "2026-04-11T23:00:00", observationHeadline: "(31% vs", observationBullets: ["(31% vs. 19%). Larger carts show less price sensitivity to small add-ons — the $26 feels smaller against a bigger order, not because of the absolute price, but because of the relative framing."] },
  ],
  "Recovery Kit × 1|61": [
    { adName: "", insight: "Positioning Recovery Kit × 1 at $61 on the upsell page instead of at checkout increased take rate by 9.4%", date: "2026-04-12T00:00:00", observationHeadline: "(18", observationBullets: ["(18.6% vs. 9.2%). A $61 item isn't a checkout impulse buy — the checkout position rushes the decision past what the price point requires. The upsell page gives the offer the space it needs."] },
    { adName: "", insight: "Showing Recovery Kit × 1 at $61 after a pillow purchase instead of a skincare purchase increased take rate by 13%", date: "2026-04-11T22:00:00", observationHeadline: "(24% vs", observationBullets: ["(24% vs. 11%). Category adjacency determines acceptance more than cart size or buyer intent — sleep-and-comfort buyers read \"recovery\" as continuous with what they came for; skincare buyers don't."] },
  ],
  "Extended Warranty × 1|9.99": [
    { adName: "", insight: "Positioning Extended Warranty × 1 at $9.99 at checkout produced an 18.1% take rate.", date: "2026-04-11T21:00:00", observationHeadline: "The combination of sub-$10 absolute price and perceived protection value operates in the \"low-consideration yes\" zone — buyers don't weigh this against other options, they either see the value instantly or skip it", observationBullets: ["The combination of sub-$10 absolute price and perceived protection value operates in the \"low-consideration yes\" zone — buyers don't weigh this against other options, they either see the value instantly or skip it."] },
  ],
  "Shipping Protection × 1|4.99": [
    { adName: "", insight: "Positioning Shipping Protection × 1 at $4.99 at checkout produced a 64.2% take rate", date: "2026-04-11T18:00:00", observationHeadline: "— the highest take rate of any offer in the account", observationBullets: ["— the highest take rate of any offer in the account. At this price and framing, the offer stops functioning as an add-on decision and starts functioning closer to a default selection — buyers include it unless they actively opt out."] },
  ],
  "Sleep Mask × 1|14": [
    { adName: "", insight: "Showing Sleep Mask × 1 at $14 on orders over $200 instead of orders under $150 increased take rate by 13%", date: "2026-04-11T15:00:00", observationHeadline: "(31% vs", observationBullets: ["(31% vs. 18%). The $14 price doesn't change; what changes is how large it feels against the rest of the order. On a $200 primary purchase, $14 reads as a small completion; on a $100 primary purchase, it reads as a meaningful addition."] },
    { adName: "", insight: "Sleep Mask × 1 at $14 performed strongest as a checkout add-on after pillow purchases", date: "2026-04-11T13:00:00", observationHeadline: ", consistent with buyers completing a sleep-focused basket — category adjacency reinforces the buying logic already in motion", observationBullets: [", consistent with buyers completing a sleep-focused basket — category adjacency reinforces the buying logic already in motion."] },
  ],
}
