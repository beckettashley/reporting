      ...
      <span className={cn("inline-flex items-center gap-1", align === "right" && "justify-end")}>
        ...
        {tooltip && (
          <span className="relative group">
            ...
            <span className="absolute left-0 top-full mt-1.5 px-3 py-2 rounded-lg border bg-background shadow-md text-xs text-foreground font-normal w-56 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition-opacity whitespace-normal" style={{ zIndex: 99999 }}>{tooltip}</span>
          </span>
        )}
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-1.5">
                ...
                <div className="relative group">
                  ...
                  <div className="absolute left-0 top-full mt-1.5 px-3 py-2 rounded-lg border bg-background shadow-md text-xs text-foreground w-64 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition-opacity" style={{ zIndex: 99999 }}>
                    ...
                    <tr className="bg-muted border-b">
                      ...
                      <th className="text-right font-medium text-foreground px-4 py-3 text-xs">
                        <span className="inline-flex items-center gap-1 justify-end">
                          ...
                          <span className="relative group">
                            <Info className="h-3 w-3 text-muted-foreground/40" />
                            <span className="absolute left-0 top-full mt-1.5 px-3 py-2 rounded-lg border bg-background shadow-md text-xs text-foreground font-normal w-56 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition-opacity whitespace-normal" style={{ zIndex: 99999 }}>Share of total orders on this page captured by each offer.</span>
                          </span>
                        </span>
                      </th>
